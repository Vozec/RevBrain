...
def parse_args():
	...
	parser.add_argument("-g",dest="win_word",type=str,required=False, help="Valid string result (ex: 'Here is the flag' ) | ex: -g \"you win\" or -g \"['win','flag']\"")
	parser.add_argument("-b",dest="fail_word",type=str,required=False,help="Fail  string result (ex: 'Invalid Password' ) | ex: -g \"failed \" or -g \"['nop','hehe']\"")
